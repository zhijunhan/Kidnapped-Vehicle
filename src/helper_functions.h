...
struct TransferredCoord {

	double x;		// Transferred x coordinate from vehicle coord to global coord [m]
	double y;		// Transferred x coordinate from vehicle coord to global coord [m]
};
